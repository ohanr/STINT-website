...
import image1 from "../../OurStoryBackground1.png"
import image2 from "../../OurStoryBackground2.png"
    ...
    return(
        <Container>
            ...
            <OurStoryContainer>
                ...
                <Bwrapper>                                      
                    <WhiteBox left="5%">
                        <Title size="20px" align="center">The "unlikely" dream</Title>
                ...
                <Image src={image1}/>     
                <WhiteBox left="51%">
                        <Title size="20px" align="center">Unlocking the doors of opportunity</Title>
                ...
                <Border height="20px"/>
                <Oval>
                    <Title color="white" align="center">Towards a more equitable job landscape</Title>
                </Oval>
            </OurStoryContainer>                   
        </Container>
    )
